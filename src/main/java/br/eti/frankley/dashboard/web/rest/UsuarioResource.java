...
/**
 * REST controller for managing {@link br.eti.frankley.dashboard.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
public class UsuarioResource {
    ...
    public ResponseEntity<List<Usuario>> getAllUsuarios(
        ...
        Page<Usuario> page;
        if (eagerload) {
            page = usuarioService.findAllWithEagerRelationships(pageable);
        } else {
            page = usuarioService.findAll(pageable);
        }
