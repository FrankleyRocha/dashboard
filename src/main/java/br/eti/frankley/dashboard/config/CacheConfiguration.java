package br.eti.frankley.dashboard.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.eti.frankley.dashboard.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.eti.frankley.dashboard.repository.UserRepository.USERS_BY_EMAIL_CACHE);
