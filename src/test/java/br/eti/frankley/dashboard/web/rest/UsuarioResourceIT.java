...
import br.eti.frankley.dashboard.service.UsuarioService;
...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity(EntityManager em) {
        Usuario usuario = new Usuario().hash(DEFAULT_HASH);
        return usuario;
    }
    ...
    public static Usuario createUpdatedEntity(EntityManager em) {
        Usuario usuario = new Usuario().hash(UPDATED_HASH);
        return usuario;
    }
    ...
    void createUsuario() throws Exception {
        ...
        assertThat(testUsuario.getHash()).isEqualTo(DEFAULT_HASH);
    }
    ...
    void putNewUsuario() throws Exception {
        ...
        updatedUsuario.hash(UPDATED_HASH);
        ...
        Usuario testUsuario = usuarioList.get(usuarioList.size() - 1);
        assertThat(testUsuario.getHash()).isEqualTo(UPDATED_HASH);
    }
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.hash(UPDATED_HASH);
